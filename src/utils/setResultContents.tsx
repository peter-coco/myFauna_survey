  ...
  switch (type) {
    case 'raccon':
      return {
        ...
        letter: (
          <div>
            요즘 네가 가장 관심 있는 게 뭐야? 나는 요즘 솜사탕을 깨끗하게 씻어 먹는 방법에 대해서
            고민중이야.
            <br />
            물로 닦아내도 순식간에 사라져버리더라고! 그래서 여러 친구와 만나서 아이디어를 얻고 있어.
            <br />
            가끔 친구들이 나에게 말해. '너는 궁금한 게 왜 이리 많아?'라고 말이지.
            <br />
            나도 내가 궁금한 게 왜 많은지는 찾지 못했어.
            <br />
            그렇지만 남들과 달라서 좋은 점은 '내 방식대로 세상을 바라보는 시선'이 생겼다는 거야.
            <br /> 내가 나로 있을 때 가장 행복한 것 같아. 너도 그렇지?
            <br /> 나답게 너답게 우리답게 즐겁게 삶을 살아가 보자. 안녕!
          </div>
        ),
      ...
      return {
        ...
        letter: (
          <div>
            차 한잔하기 좋은 날이다.그렇지?
            <br />
            요즘 친구들 너무 바쁘게 사는 거 같지 않아? 꼭 그렇게 서두르지 않아도 될 거 같은데
            말이지.
            <br />
            나만의 페이스를 유지하고 하고자 하는 일을 준비한다면
            <br />
            꼭 이뤄낼 수 있을 거야. 남들보다 좀 느리면 어때? 내가 행복한 게 가장 중요한걸.
            <br />
      ...
      return {
        ...
        letter: (
          <div>
            ...
            나에게 친구란 하나의 책과도 같아.
            <br />
            각자 다른 이야기가 있고 그걸 들을 때 이런 삶도 있다는 걸 느껴.
            <br />
            그래서 누구도 쉽게 싫어할 수 없는 거 같아.
            <br />
            완벽한 사람은 없으니까.
            <br /> 그래서 친구들이 나에게 고민을 자주 털어놓는 거 같아.
            <br /> 있는 그대로의 자신을 존중해주니까.
            <br /> 나도 흥미롭고 좋아. 그렇지만 내 페이스는 꼭 유지하고 있어.
      ...
      return {
        ...
        letter: (
          <div>
            ...
            <br />
            나비도 날아다니고 바람도 산들산들 불어서 기분이 참 좋더라.
            <br />
            포근한 풍경이 너무 좋아서 나도 모르게 한참을 걸어버렸어.
            <br />
            그러다 보니까 문득 네가 생각났어. 요즘 힘들다고 했잖아
      ...
      return {
        ...
        letter: (
          <div>
            ...
            <br />
            최근에 혼자 돌아다니다가 해바라기밭을 발견했지 뭐야.
            <br />
            그래서 혼자서 씨를 들고 오려고 했는데 볼주머니가 터질 거 같아서 못 했어.
            <br />
            같이 가면서 어떻게 지냈는지 알려줘. 한동안 연락이 없었잖아.
            <br />
            말 못하는 거라면 굳이 말하지 않아도 돼.
            <br /> 만약 말하게 되더라도 걱정하지 마. 비밀 완전 보장! 알지?
      ...
      return {
        ...
        letter: (
          <div>
            ...
            <br />
            일하고 자고.. 계속 반복하다보니 시간이 어떻게 흘러갔는지도 모르겠네.
            <br />
            넌 어떻게 지냈어? 우리 한 번 만나야지.
            <br />
            바빠도 이해해.
            <br /> 나는 너가 잘 되는게 좋고, 우리는 언제든 만날 수 있으니까 걱정하지마.
            <br />
            시간 될 때 연락줘. 우리 자주 가는 단골집 있잖아. 거기가서 당근 스프랑 주스 마시자.
            <br />
    ...
    case 'cat':
      return {
        ...
        letter: (
          <div>
            온종일 집에서만 있다 보니까 시간 가는 줄 몰랐어.
            <br />
            혼자서 할 게 너무 많아.
            <br />
            노래도 듣고, 책도 읽고, 게임도 하고, 요리도 하고 등등
            <br />
            너도 그렇지? 친구들은 안 만나냐고?
            <br />
            알잖아. 친구들이 좋긴 한데 가끔 만나야 좋은 거 같아.
            <br /> 그 이상은 뭔가 피곤하고 귀찮을 때가 종종 있어.
            <br /> 나한테는 내 시간이 가장 중요해서 말이지~
            <br /> 우리 너무 신경을 쓰지 말자. 연락할 사람은 연락하게 돼 있잖아? 나만의 시간을
            즐기자고.
          </div>
        ),
      ...
      return {
        ...
        letter: (
          <div>
            ...
            <br />
            하늘에 물어보지만, 답을 찾을 수는 없는 것 같아. 그래서 계속 나만의 답을 찾아다니고 있어.
            이런 생각을 누군가에게 말하기는 조심스럽더라고.
            <br />
            왜냐고 물어본다면…. 나를 이해해주지 않을 거 같아서 그래. 난 혼자만의 생각이 너무
            소중하고 중요하거든.
            <br />
            그리고 생각의 과정이 즐거워. 가끔 끝도 없는 고독함에 빠지기도 하지만 오히려 내가
            존재하는 이유를 알려주기도 해.
            <br />
            너한테만은 말할 수 있을 거 같아서 이렇게 편지해. 어디서든 너를 응원하고 있을게. 기죽지
            마.
          </div>
        ),
